...
- The details panel has a `Study Info` mode for local notes and a separate `Dictionary API` mode for richer external data from `api.dictionaryapi.dev`, including clickable source links.
