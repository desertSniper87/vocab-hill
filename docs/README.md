...
This folder is the source of truth for project structure, decisions, and implementation notes.
...
- [ADR-003: Use A Manual Sync Key With A Small Interchangeable Sync Backend](2-architecture/decisions/ADR-003-sync-key-backend.md)
